...
class Users(models.Model):
    ...
    photo = models.ImageField('Аватарка пользователя',null=True, upload_to='static/media/users/', storage=VideoStorage())
...
class Payments(models.Model):
    ...
    def __str__(self):
        return f'{self.user.tg_username} - {self.summa} руб.'
